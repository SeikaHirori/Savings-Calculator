...
public class SavingsCalculatorApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //misc for TMC testing
        Slider sliderSaving = savings.getSlider();
        Slider sliderInterest = interest.getSlider();
        ...
        savings.getSlider().valueProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                if (!savings.getSlider().isValueChanging()) {
                    layout.setCenter(lineChart.getLineChart());
                    updateSliders(sliderSaving, sliderInterest, lineChart);
                }
            }
    ...
    private static void updateSliders(Slider sliderSaving, Slider sliderInterest, SavingsGraph lineChart) {
        sliderSaving = lineChart.getSavingsSlider();
        sliderInterest = lineChart.getInterestSlider();
    }
